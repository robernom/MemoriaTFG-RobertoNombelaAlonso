...
\section{Interfaz de entrada}
\label{app:interfaz-entrada}

FIXME: hablar del interfaz de entrada

\section{Interfaz de resultados}
\label{app:interfaz-resultados}

En la figura~\ref{figura:dr-ai-score} se muestra un ejemplo del interfaz web que el usuario ve una vez su proyecto ha sido analizado. FIXME: elaborar un poco más qué se ve en la figura.
